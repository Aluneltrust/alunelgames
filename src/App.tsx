...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] dark:bg-[#09090b] text-gray-900 dark:text-white relative">
      ...
      {/* Fixed Header */}
      <header className="sticky top-0 z-40 backdrop-blur-xl bg-white/70 dark:bg-[#09090b]/70 border-b border-gray-200/50 dark:border-white/[0.06]">
        <div className="max-w-5xl mx-auto px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900 dark:text-white">
              <span className="relative inline-block mr-3">ALUNEL<span className="absolute -top-0.5 -right-4 text-[8px] font-normal opacity-50">TM</span></span> Games
            </h1>
            <span className="hidden sm:block text-xs text-gray-400 dark:text-gray-500 border-l border-gray-200 dark:border-white/10 pl-3">
              One wallet. All your games.
            </span>
          </div>
          <button
            onClick={toggleTheme}
            className="w-9 h-9 rounded-xl bg-white dark:bg-white/10 border border-gray-200 dark:border-white/10 shadow-sm flex items-center justify-center text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-white/15 transition-all"
      ...
      <div className="relative z-10 max-w-5xl w-full mx-auto px-6 py-8">
        {/* Wallet */}
